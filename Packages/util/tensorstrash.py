...
def tens_interp_3d(x, y, z, tensor_field):
    ...
    if x == math.floor(x) and y == math.floor(y) and z == math.floor(z):
        ...
        tens[0, 0] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps11[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps11[
                         math.ceil(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps11[
                         math.floor(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps11[
                         math.floor(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps11[
                         math.ceil(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps11[
                         math.ceil(x), math.floor(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps11[
                         math.floor(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps11[
                         math.floor(x), math.floor(y), math.floor(z)]
        tens[0, 1] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps12[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps12[
                         math.ceil(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps12[
                         math.floor(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps12[
                         math.floor(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps12[
                         math.ceil(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps12[
                         math.ceil(x), math.floor(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps12[
                         math.floor(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps12[
                         math.floor(x), math.floor(y), math.floor(z)]
        tens[1, 0] = tens[0, 1]
        tens[0, 2] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps13[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps13[
                         math.ceil(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps13[
                         math.floor(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps13[
                         math.floor(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps13[
                         math.ceil(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps13[
                         math.ceil(x), math.floor(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps13[
                         math.floor(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps13[
                         math.floor(x), math.floor(y), math.floor(z)]
        tens[2, 0] = tens[0, 2]
        tens[1, 1] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps22[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps22[
                         math.ceil(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps22[
                         math.floor(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps22[
                         math.floor(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps22[
                         math.ceil(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps22[
                         math.ceil(x), math.floor(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps22[
                         math.floor(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps22[
                         math.floor(x), math.floor(y), math.floor(z)]
        tens[1, 2] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps23[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps23[
                         math.ceil(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps23[
                         math.floor(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps23[
                         math.floor(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps23[
                         math.ceil(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps23[
                         math.ceil(x), math.floor(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps23[
                         math.floor(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps23[
                         math.floor(x), math.floor(y), math.floor(z)]
        tens[2, 1] = tens[1, 2]
        tens[2, 2] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps33[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps33[
                         math.ceil(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * eps33[
                         math.floor(x), math.ceil(y), math.ceil(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * eps33[
                         math.floor(x), math.floor(y), math.ceil(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps33[
                         math.ceil(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps33[
                         math.ceil(x), math.floor(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * eps33[
                         math.floor(x), math.ceil(y), math.floor(z)] \
                     + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * eps33[
                         math.floor(x), math.floor(y), math.floor(z)]
...
def batch_tens_interp_3d_torch(x, y, z, tensor_field):
    ...
    try:
        if len(intidx[0]) > 0:
            tens[intidx[0][:], 0, 0] = x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps11[ceil_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps11[ceil_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps11[floor_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps11[floor_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps11[ceil_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps11[ceil_x[intidx], floor_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps11[floor_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps11[floor_x[intidx], floor_y[intidx], floor_z[intidx]]
            tens[intidx[0][:], 0, 1] = x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps12[ceil_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps12[ceil_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps12[floor_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps12[floor_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps12[ceil_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps12[ceil_x[intidx], floor_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps12[floor_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps12[floor_x[intidx], floor_y[intidx], floor_z[intidx]]
            tens[intidx[0][:], 1, 0] = tens[intidx[0][:], 0, 1]
            tens[intidx[0][:], 0, 2] = x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps13[ceil_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps13[ceil_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps13[floor_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps13[floor_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps13[ceil_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps13[ceil_x[intidx], floor_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps13[floor_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps13[floor_x[intidx], floor_y[intidx], floor_z[intidx]]
            tens[intidx[0][:], 2, 0] = tens[intidx[0][:], 0, 2]
            tens[intidx[0][:], 1, 1] = x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps22[ceil_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps22[ceil_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps22[floor_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps22[floor_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps22[ceil_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps22[ceil_x[intidx], floor_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps22[floor_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps22[floor_x[intidx], floor_y[intidx], floor_z[intidx]]
            tens[intidx[0][:], 1, 2] = x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps23[ceil_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps23[ceil_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps23[floor_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps23[floor_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps23[ceil_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps23[ceil_x[intidx], floor_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps23[floor_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps23[floor_x[intidx], floor_y[intidx], floor_z[intidx]]
            tens[intidx[0][:], 2, 1] = tens[intidx[0][:], 1, 2]
            tens[intidx[0][:], 2, 2] = x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps33[ceil_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps33[ceil_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps33[floor_x[intidx], ceil_y[intidx], ceil_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_floor_z[intidx] * \
                                       eps33[floor_x[intidx], floor_y[intidx], ceil_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps33[ceil_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_floor_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps33[ceil_x[intidx], floor_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_floor_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps33[floor_x[intidx], ceil_y[intidx], floor_z[intidx]] \
                                       + x_minus_ceil_x[intidx] * y_minus_ceil_y[intidx] * z_minus_ceil_z[intidx] * \
                                       eps33[floor_x[intidx], floor_y[intidx], floor_z[intidx]]
    except Exception as err:
        print('Caught Exception:', err)
        print('intidx:', intidx)
...
def vect_interp_3d(x, y, z, vector_field):
    ...
    if x == math.floor(x) and y == math.floor(y) and z == math.floor(z):
        ...
        vect[0] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * v1[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * v1[
                      math.ceil(x), math.floor(y), math.ceil(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * v1[
                      math.floor(x), math.ceil(y), math.ceil(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * v1[
                      math.floor(x), math.floor(y), math.ceil(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * v1[
                      math.ceil(x), math.ceil(y), math.floor(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * v1[
                      math.ceil(x), math.floor(y), math.floor(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * v1[
                      math.floor(x), math.ceil(y), math.floor(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * v1[
                      math.floor(x), math.floor(y), math.floor(z)]
        vect[1] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * v2[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * v2[
                      math.ceil(x), math.floor(y), math.ceil(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * v2[
                      math.floor(x), math.ceil(y), math.ceil(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * v2[
                      math.floor(x), math.floor(y), math.ceil(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * v2[
                      math.ceil(x), math.ceil(y), math.floor(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * v2[
                      math.ceil(x), math.floor(y), math.floor(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * v2[
                      math.floor(x), math.ceil(y), math.floor(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * v2[
                      math.floor(x), math.floor(y), math.floor(z)]
        vect[2] = abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * v3[
            math.ceil(x), math.ceil(y), math.ceil(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * v3[
                      math.ceil(x), math.floor(y), math.ceil(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.floor(z)) * v3[
                      math.floor(x), math.ceil(y), math.ceil(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.floor(z)) * v3[
                      math.floor(x), math.floor(y), math.ceil(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * v3[
                      math.ceil(x), math.ceil(y), math.floor(z)] \
                  + abs(x - math.floor(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * v3[
                      math.ceil(x), math.floor(y), math.floor(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.floor(y)) * abs(z - math.ceil(z)) * v3[
                      math.floor(x), math.ceil(y), math.floor(z)] \
                  + abs(x - math.ceil(x)) * abs(y - math.ceil(y)) * abs(z - math.ceil(z)) * v3[
                      math.floor(x), math.floor(y), math.floor(z)]
    return (vect)
