...
def eulerpath_vectbase_2d(vector_field, mask_image, start_coordinate, delta_t=0.25, iter_num=700, filename='',
    ...
    if both_directions:
        back_x, back_y = eulerpath_vectbase_2d(vector_field, mask_image, start_coordinate, -delta_t, iter_num, filename,
                                               both_directions=False)
...
def eulerpath_vectbase_2d_w_dv(vector_lin, mask_image, start_coordinate, delta_t=0.25, iter_num=700, filename='',
                               both_directions=False):
    if both_directions:
        back_x, back_y = eulerpath_vectbase_2d_w_dv(-vector_lin, mask_image, start_coordinate, delta_t, iter_num,
                                                    filename, both_directions=False)
